namespace DiplomaApp.Core
{
    public static class Constants
    {
        public const int recordsPerPage = 40;     
        public const int defaultSimiliarityRatio = 85;     
        public const int minWaitMilliseconds = 2000;     
        ...
        public const double parseTimeoutSeconds = 1800;
